...
public class DeleteAcousticModelOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteAcousticModelOptions instance.
     *
     * @param deleteAcousticModelOptions the instance to initialize the Builder with
     */
