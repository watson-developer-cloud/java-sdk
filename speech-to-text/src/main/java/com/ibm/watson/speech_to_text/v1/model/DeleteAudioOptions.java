...
public class DeleteAudioOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteAudioOptions instance.
     *
     * @param deleteAudioOptions the instance to initialize the Builder with
     */
