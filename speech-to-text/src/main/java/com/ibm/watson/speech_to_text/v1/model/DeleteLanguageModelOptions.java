...
public class DeleteLanguageModelOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteLanguageModelOptions instance.
     *
     * @param deleteLanguageModelOptions the instance to initialize the Builder with
     */
  ...
  protected DeleteLanguageModelOptions() {}

  protected DeleteLanguageModelOptions(Builder builder) {
