 ...
 */
public class EnrichedResults extends GenericModel {

  protected EnrichedResultsTranscript transcript;
  protected String status;

  protected EnrichedResults() {}
   ...
   */
  public EnrichedResultsTranscript getTranscript() {
    return transcript;
  }
   ...
   * Gets the status.
   *
   * <p>The status of the enriched transcription.
   *
   * @return the status
   */
