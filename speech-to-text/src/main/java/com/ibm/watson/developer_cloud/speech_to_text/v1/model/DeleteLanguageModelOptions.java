...
public class DeleteLanguageModelOptions extends GenericModel {
  ...
  private DeleteLanguageModelOptions(Builder builder) {
   ...
   *
   * The GUID of the custom language model that is to be deleted. You must make the request with service credentials
