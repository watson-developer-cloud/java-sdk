 ...
 * CreateLanguageModel.
 */
public class CreateLanguageModel extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(CreateLanguageModel createLanguageModel) {
      name = createLanguageModel.name;
      baseModelName = createLanguageModel.baseModelName;
      dialect = createLanguageModel.dialect;
    ...
    /**
     * Builds a CreateLanguageModel.
     *
     * @return the createLanguageModel
     */
    public CreateLanguageModel build() {
      return new CreateLanguageModel(this);
    }
     ...
     *
     * @param name the name
     * @return the CreateLanguageModel builder
     */
  ...
  private CreateLanguageModel(Builder builder) {
   ...
   * New builder.
   *
   * @return a CreateLanguageModel builder
   */
