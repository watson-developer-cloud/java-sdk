...
public class EntitiesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing EntitiesOptions instance.
     *
     * @param entitiesOptions the instance to initialize the Builder with
     */
     ...
     *
     * @return the new EntitiesOptions instance
     */
