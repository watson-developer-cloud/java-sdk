 ...
 *
 * ### Concepts Identify general concepts that are referenced or alluded to in your content. Concepts that are detected
 * typically have an associated link to a DBpedia resource.
 *
 * ### Entities Detect important people, places, geopolitical entities and other types of entities in your content.
 * Entity detection recognizes consecutive coreferences of each entity. For example, analysis of the following text
 ...
 *
 * ### Keywords Determine the most important keywords in your content. Keyword phrases are organized by relevance in the
 * results.
 *
 * ### Categories Categorize your content into a hierarchical 5-level taxonomy. For example, "Leonardo DiCaprio won an
 * Oscar" returns "/art and entertainment/movies and tv/movies" as the most confident classification.
 *
 * ### Sentiment Determine whether your content conveys postive or negative sentiment. Sentiment information can be
 * returned for detected entities, keywords, or user-specified target phrases found in the text.
 *
 * ### Emotion Detect anger, disgust, fear, joy, or sadness that is conveyed by your content. Emotion information can be
 * returned for detected entities, keywords, or user-specified target phrases found in the text.
 *
 * ### Relations Recognize when two entities are related, and identify the type of relation. For example, you can
 * identify an "awardedTo" relation between an award and its recipient.
 *
 * ### Semantic Roles Parse sentences into subject-action-object form, and identify entities and keywords that are
