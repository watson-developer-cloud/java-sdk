...
/** Unit test class for the SyntaxOptions model. */
public class SyntaxOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSyntaxOptions() throws Throwable {
    ...
    String json = TestUtilities.serialize(syntaxOptionsModel);

    SyntaxOptions syntaxOptionsModelNew = TestUtilities.deserialize(json, SyntaxOptions.class);
    assertTrue(syntaxOptionsModelNew instanceof SyntaxOptions);
    assertEquals(syntaxOptionsModelNew.tokens().toString(), syntaxOptionsTokensModel.toString());
    assertEquals(syntaxOptionsModelNew.sentences(), Boolean.valueOf(true));
  }
}
