...
```gradle
'com.ibm.watson.developer_cloud:assistant:6.2.0'
```
...
```sh
cd java-sdk
gradle jar  # build jar file (build/libs/watson-developer-cloud-6.2.0.jar)
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/java-sdk-6.2.0/java-sdk-6.2.0-jar-with-dependencies.jar