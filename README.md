...
```gradle
'com.ibm.watson:ibm-watson:7.1.1'
```

Only Assistant:

```gradle
'com.ibm.watson:assistant:7.1.1'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/java-sdk-7.1.1/ibm-watson-7.1.1-jar-with-dependencies.jar
