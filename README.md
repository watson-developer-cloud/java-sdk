...
```gradle
'com.ibm.watson:ibm-watson:16.0.0'
```

Only Assistant:

```gradle
'com.ibm.watson:assistant:16.0.0'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/v16.0.0/ibm-watson-16.0.0-jar-with-dependencies.jar
