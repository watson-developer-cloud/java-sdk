...
```gradle
'com.ibm.watson:ibm-watson:9.2.1'
```

Only Assistant:

```gradle
'com.ibm.watson:assistant:9.2.1'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/v9.2.1/ibm-watson-9.2.1-jar-with-dependencies.jar
