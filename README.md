...
```gradle
'com.ibm.watson:ibm-watson:14.0.1'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/v14.0.1/ibm-watson-14.0.1-jar-with-dependencies.jar
