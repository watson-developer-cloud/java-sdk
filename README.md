...
```gradle
'com.ibm.watson:assistant:9.3.0'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/v9.3.0/ibm-watson-9.3.0-jar-with-dependencies.jar
