...
```gradle
'com.ibm.watson:ibm-watson:9.0.0-rc.1'
```

Only Assistant:

```gradle
'com.ibm.watson:assistant:9.0.0-rc.1'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/v9.0.0-rc.1/ibm-watson-9.0.0-rc.1-jar-with-dependencies.jar
