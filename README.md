...
```gradle
'com.ibm.watson.developer_cloud:java-sdk:6.1.1'
```

Only Assistant:

```gradle
'com.ibm.watson.developer_cloud:assistant:6.1.1'
```
...
```gradle
'com.ibm.watson.developer_cloud:speech-to-text:6.1.2-SNAPSHOT'
```
...
```sh
cd java-sdk
gradle jar  # build jar file (build/libs/watson-developer-cloud-6.1.1.jar)
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/java-sdk-6.1.1/java-sdk-6.1.1-jar-with-dependencies.jar
