...
```gradle
'com.ibm.watson:ibm-watson:8.6.0'
```

Only Assistant:

```gradle
'com.ibm.watson:assistant:8.6.0'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/v8.6.0/ibm-watson-8.6.0-jar-with-dependencies.jar
