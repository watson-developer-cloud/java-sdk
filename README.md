...
```gradle
'com.ibm.watson:ibm-watson:8.6.1'
```

Only Assistant:

```gradle
'com.ibm.watson:assistant:8.6.1'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/v8.6.1/ibm-watson-8.6.1-jar-with-dependencies.jar
