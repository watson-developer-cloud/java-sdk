...
```gradle
'com.ibm.watson:ibm-watson:8.1.0'
```

Only Assistant:

```gradle
'com.ibm.watson:assistant:8.1.0'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/java-sdk-8.1.0/ibm-watson-8.1.0-jar-with-dependencies.jar
