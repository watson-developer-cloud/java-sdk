...
```gradle
'com.ibm.watson:ibm-watson:9.2.2'
```

Only Assistant:

```gradle
'com.ibm.watson:assistant:9.2.2'
```
...
[jar]: https://github.com/watson-developer-cloud/java-sdk/releases/download/v9.2.2/ibm-watson-9.2.2-jar-with-dependencies.jar
