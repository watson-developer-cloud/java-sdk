 ...
 * New: Conversation watson.developer_cloud.retrieve_and_rank.v1: `MessageRequest` now supports entities and intents
 * New: AlchemyLanguage `typedRelations` entities and intents
 * New: Speech to Text `keyword_spotting`
 * Fix: Remove Relationship extraction watson.developer_cloud.retrieve_and_rank.v1 Beta
 ...
 * New: Conversation watson.developer_cloud.retrieve_and_rank.v1
 ...
 * Fix: Removed Relationship Extraction watson.developer_cloud.retrieve_and_rank.v1-beta
 ...
 * New: Services added:
   ...
   * Conversation watson.developer_cloud.retrieve_and_rank.v1-experimental
   * Tone Analyzer v3
