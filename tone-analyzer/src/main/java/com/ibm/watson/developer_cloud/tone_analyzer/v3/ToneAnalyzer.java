...
public class ToneAnalyzer extends WatsonService {
   ...
   * default encoding for plain text and HTML is ISO-8859-1 (effectively, the ASCII character set). When specifying a
   ...
   * and analyzes only the textual content.
   *
   ...
   * 500 characters.   Per the JSON specification, the default character encoding for JSON content is effectively
   * always UTF-8.
   *
