...
public class DocumentAnalysis extends GenericModel {
   ...
   * **`2016-05-19`:** An array of `ToneCategory` objects that provides the results
   * of the tone analysis for the full document of the input content. The service returns results only for the tones
