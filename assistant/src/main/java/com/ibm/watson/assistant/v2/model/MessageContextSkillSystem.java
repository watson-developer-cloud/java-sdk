...
public class MessageContextSkillSystem extends DynamicModel<Object> {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing MessageContextSkillSystem instance.
     *
     * @param messageContextSkillSystem the instance to initialize the Builder with
     */
