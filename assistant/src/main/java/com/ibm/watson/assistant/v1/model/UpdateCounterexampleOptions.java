...
public class UpdateCounterexampleOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateCounterexampleOptions instance.
     *
     * @param updateCounterexampleOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateCounterexampleOptions() {}
