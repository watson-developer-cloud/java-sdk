...
public class MessageStreamOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing MessageStreamOptions instance.
     *
     * @param messageStreamOptions the instance to initialize the Builder with
     */
    private Builder(MessageStreamOptions messageStreamOptions) {
      this.assistantId = messageStreamOptions.assistantId;
      this.environmentId = messageStreamOptions.environmentId;
      this.sessionId = messageStreamOptions.sessionId;
      this.input = messageStreamOptions.input;
      this.context = messageStreamOptions.context;
      this.userId = messageStreamOptions.userId;
    }
    ...
    /**
     * Builds a MessageStreamOptions.
     *
     * @return the new MessageStreamOptions instance
     */
    public MessageStreamOptions build() {
      return new MessageStreamOptions(this);
    }
     ...
     *
     * @param assistantId the assistantId
     * @return the MessageStreamOptions builder
     */
  ...
  protected MessageStreamOptions() {}

  protected MessageStreamOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a MessageStreamOptions builder
   */
