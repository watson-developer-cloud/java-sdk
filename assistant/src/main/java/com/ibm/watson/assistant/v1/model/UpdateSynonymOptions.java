...
public class UpdateSynonymOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateSynonymOptions instance.
     *
     * @param updateSynonymOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateSynonymOptions() {}
