...
public class RuntimeResponseGenericRuntimeResponseTypeAudio extends RuntimeResponseGeneric {
  ...
  public static class Builder {
    ...
    public Builder(RuntimeResponseGeneric runtimeResponseGenericRuntimeResponseTypeAudio) {
      ...
      this.title = runtimeResponseGenericRuntimeResponseTypeAudio.title;
      this.description = runtimeResponseGenericRuntimeResponseTypeAudio.description;
      this.channels = runtimeResponseGenericRuntimeResponseTypeAudio.channels;
      this.channelOptions = runtimeResponseGenericRuntimeResponseTypeAudio.channelOptions;
      this.altText = runtimeResponseGenericRuntimeResponseTypeAudio.altText;
    }
    ...
    /**
     * Builds a RuntimeResponseGenericRuntimeResponseTypeAudio.
     *
     * @return the new RuntimeResponseGenericRuntimeResponseTypeAudio instance
     */
    public RuntimeResponseGenericRuntimeResponseTypeAudio build() {
      return new RuntimeResponseGenericRuntimeResponseTypeAudio(this);
    }
     ...
     * @return the RuntimeResponseGenericRuntimeResponseTypeAudio builder
     */
   ...
   * New builder.
   *
   * @return a RuntimeResponseGenericRuntimeResponseTypeAudio builder
   */
