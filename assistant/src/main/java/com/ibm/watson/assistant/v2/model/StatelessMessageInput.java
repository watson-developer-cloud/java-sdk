...
public class StatelessMessageInput extends GenericModel {
  ...
  protected StatelessMessageInputOptions options;
  ...
  public static class Builder {
    ...
    private StatelessMessageInputOptions options;

    /**
     * Instantiates a new Builder from an existing StatelessMessageInput instance.
     *
     * @param statelessMessageInput the instance to initialize the Builder with
     */
    private Builder(StatelessMessageInput statelessMessageInput) {
      this.messageType = statelessMessageInput.messageType;
      this.text = statelessMessageInput.text;
      this.intents = statelessMessageInput.intents;
      this.entities = statelessMessageInput.entities;
      this.suggestionId = statelessMessageInput.suggestionId;
      this.attachments = statelessMessageInput.attachments;
      this.analytics = statelessMessageInput.analytics;
      this.options = statelessMessageInput.options;
    }
    ...
    /**
     * Builds a StatelessMessageInput.
     *
     * @return the new StatelessMessageInput instance
     */
    public StatelessMessageInput build() {
      return new StatelessMessageInput(this);
    }
     ...
     * @return the StatelessMessageInput builder
     */
     ...
     * @return the StatelessMessageInput builder
     */
    public Builder options(StatelessMessageInputOptions options) {
      this.options = options;
      return this;
    }
  }

  protected StatelessMessageInput() {}

  protected StatelessMessageInput(Builder builder) {
   ...
   * New builder.
   *
   * @return a StatelessMessageInput builder
   */
   ...
   * @return the options
   */
  public StatelessMessageInputOptions options() {
    return options;
  }
}
