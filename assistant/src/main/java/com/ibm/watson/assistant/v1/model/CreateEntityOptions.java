...
public class CreateEntityOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing CreateEntityOptions instance.
     *
     * @param createEntityOptions the instance to initialize the Builder with
     */
