...
public class ListProvidersOptions extends GenericModel {
  ...
  /**
   * The attribute by which returned conversational skill providers will be sorted. To reverse the
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListProvidersOptions instance.
     *
     * @param listProvidersOptions the instance to initialize the Builder with
     */
    private Builder(ListProvidersOptions listProvidersOptions) {
      this.pageLimit = listProvidersOptions.pageLimit;
      this.includeCount = listProvidersOptions.includeCount;
      this.sort = listProvidersOptions.sort;
      this.cursor = listProvidersOptions.cursor;
      this.includeAudit = listProvidersOptions.includeAudit;
    }
  ...
  protected ListProvidersOptions() {}
   ...
   * Gets the sort.
   *
   * <p>The attribute by which returned conversational skill providers will be sorted. To reverse
