...
public class WorkspaceSystemSettingsSystemEntities extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing WorkspaceSystemSettingsSystemEntities instance.
     *
     * @param workspaceSystemSettingsSystemEntities the instance to initialize the Builder with
     */
