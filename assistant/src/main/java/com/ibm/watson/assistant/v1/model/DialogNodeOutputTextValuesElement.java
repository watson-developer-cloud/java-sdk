...
public class DialogNodeOutputTextValuesElement extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DialogNodeOutputTextValuesElement instance.
     *
     * @param dialogNodeOutputTextValuesElement the instance to initialize the Builder with
     */
  ...
  protected DialogNodeOutputTextValuesElement() {}
