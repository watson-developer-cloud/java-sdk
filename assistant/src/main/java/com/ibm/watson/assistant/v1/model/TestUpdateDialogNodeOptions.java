...
/** The testUpdateDialogNode options. */
public class TestUpdateDialogNodeOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(TestUpdateDialogNodeOptions testUpdateDialogNodeOptions) {
      this.workspaceId = testUpdateDialogNodeOptions.workspaceId;
      this.dialogNode = testUpdateDialogNodeOptions.dialogNode;
      this.body = testUpdateDialogNodeOptions.body;
      this.includeAudit = testUpdateDialogNodeOptions.includeAudit;
    }
    ...
    /**
     * Builds a TestUpdateDialogNodeOptions.
     *
     * @return the new TestUpdateDialogNodeOptions instance
     */
    public TestUpdateDialogNodeOptions build() {
      return new TestUpdateDialogNodeOptions(this);
    }
     ...
     *
     * @param workspaceId the workspaceId
     * @return the TestUpdateDialogNodeOptions builder
     */
  ...
  protected TestUpdateDialogNodeOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a TestUpdateDialogNodeOptions builder
   */
