...
public class WorkspaceSystemSettingsDisambiguation extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing WorkspaceSystemSettingsDisambiguation instance.
     *
     * @param workspaceSystemSettingsDisambiguation the instance to initialize the Builder with
     */
