...
public class MessageContextGlobalSystem extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing MessageContextGlobalSystem instance.
     *
     * @param messageContextGlobalSystem the instance to initialize the Builder with
     */
