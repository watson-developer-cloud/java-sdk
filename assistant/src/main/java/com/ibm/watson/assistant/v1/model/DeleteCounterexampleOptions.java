...
public class DeleteCounterexampleOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteCounterexampleOptions instance.
     *
     * @param deleteCounterexampleOptions the instance to initialize the Builder with
     */
