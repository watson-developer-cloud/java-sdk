...
public class StatelessFinalResponse extends GenericModel {

  protected StatelessFinalResponseOutput output;
  protected StatelessMessageContext context;

  @SerializedName("user_id")
  protected String userId;

  protected StatelessFinalResponse() {}
   ...
   * @return the output
   */
  public StatelessFinalResponseOutput getOutput() {
    return output;
  }
