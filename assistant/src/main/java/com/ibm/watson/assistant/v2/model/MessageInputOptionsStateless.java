...
public class MessageInputOptionsStateless extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing MessageInputOptionsStateless instance.
     *
     * @param messageInputOptionsStateless the instance to initialize the Builder with
     */
