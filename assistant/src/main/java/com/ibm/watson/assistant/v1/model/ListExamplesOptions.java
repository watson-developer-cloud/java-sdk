...
public class ListExamplesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListExamplesOptions instance.
     *
     * @param listExamplesOptions the instance to initialize the Builder with
     */
