...
public class DialogNodeOutputModifiers extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DialogNodeOutputModifiers instance.
     *
     * @param dialogNodeOutputModifiers the instance to initialize the Builder with
     */
