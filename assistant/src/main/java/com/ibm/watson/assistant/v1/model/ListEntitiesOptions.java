...
public class ListEntitiesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListEntitiesOptions instance.
     *
     * @param listEntitiesOptions the instance to initialize the Builder with
     */
     ...
     *
     * @return the new ListEntitiesOptions instance
     */
