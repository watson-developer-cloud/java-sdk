...
public class ListSynonymsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListSynonymsOptions instance.
     *
     * @param listSynonymsOptions the instance to initialize the Builder with
     */
