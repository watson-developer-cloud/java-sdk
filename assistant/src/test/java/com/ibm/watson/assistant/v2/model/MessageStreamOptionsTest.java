...
/** Unit test class for the MessageStreamOptions model. */
public class MessageStreamOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMessageStreamOptions() throws Throwable {
    ...
    MessageStreamOptions messageStreamOptionsModel =
        new MessageStreamOptions.Builder()
            ...
            .userId("testString")
            .build();
    assertEquals(messageStreamOptionsModel.assistantId(), "testString");
    assertEquals(messageStreamOptionsModel.environmentId(), "testString");
    assertEquals(messageStreamOptionsModel.sessionId(), "testString");
    assertEquals(messageStreamOptionsModel.input(), messageInputModel);
    assertEquals(messageStreamOptionsModel.context(), messageContextModel);
    assertEquals(messageStreamOptionsModel.userId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testMessageStreamOptionsError() throws Throwable {
    new MessageStreamOptions.Builder().build();
  }
}
