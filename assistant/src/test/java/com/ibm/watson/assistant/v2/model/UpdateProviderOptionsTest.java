...
/** Unit test class for the UpdateProviderOptions model. */
public class UpdateProviderOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateProviderOptions() throws Throwable {
    ...
    UpdateProviderOptions updateProviderOptionsModel =
        new UpdateProviderOptions.Builder()
            ...
            .build();
    assertEquals(updateProviderOptionsModel.providerId(), "testString");
    assertEquals(updateProviderOptionsModel.specification(), providerSpecificationModel);
    assertEquals(updateProviderOptionsModel.xPrivate(), providerPrivateModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateProviderOptionsError() throws Throwable {
    new UpdateProviderOptions.Builder().build();
  }
}
