...
/** Unit test class for the MessageInputOptions model. */
public class MessageInputOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMessageInputOptions() throws Throwable {
    ...
    assertEquals(messageInputOptionsModelNew.asyncCallout(), Boolean.valueOf(false));
    assertEquals(
