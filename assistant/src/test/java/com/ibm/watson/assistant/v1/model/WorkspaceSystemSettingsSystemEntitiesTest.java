...
/** Unit test class for the WorkspaceSystemSettingsSystemEntities model. */
public class WorkspaceSystemSettingsSystemEntitiesTest {
  ...
  public void testWorkspaceSystemSettingsSystemEntities() throws Throwable {
    ...
    WorkspaceSystemSettingsSystemEntities workspaceSystemSettingsSystemEntitiesModelNew =
        TestUtilities.deserialize(json, WorkspaceSystemSettingsSystemEntities.class);
    assertTrue(
