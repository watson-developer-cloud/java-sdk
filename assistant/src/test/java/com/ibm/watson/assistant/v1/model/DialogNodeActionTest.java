...
/** Unit test class for the DialogNodeAction model. */
public class DialogNodeActionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDialogNodeAction() throws Throwable {
    ...
    String json = TestUtilities.serialize(dialogNodeActionModel);

    DialogNodeAction dialogNodeActionModelNew =
        TestUtilities.deserialize(json, DialogNodeAction.class);
  ...
  public void testDialogNodeActionError() throws Throwable {
    new DialogNodeAction.Builder().build();
  }
}
