...
/** Unit test class for the GetExampleOptions model. */
public class GetExampleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetExampleOptions() throws Throwable {
  ...
  public void testGetExampleOptionsError() throws Throwable {
    new GetExampleOptions.Builder().build();
  }
}
