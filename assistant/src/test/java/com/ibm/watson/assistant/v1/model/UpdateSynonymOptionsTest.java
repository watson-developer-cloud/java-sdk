...
/** Unit test class for the UpdateSynonymOptions model. */
public class UpdateSynonymOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateSynonymOptions() throws Throwable {
  ...
  public void testUpdateSynonymOptionsError() throws Throwable {
    new UpdateSynonymOptions.Builder().build();
  }
}
