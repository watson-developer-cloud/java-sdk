...
/** Unit test class for the MessageStreamStatelessOptions model. */
public class MessageStreamStatelessOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMessageStreamStatelessOptions() throws Throwable {
    ...
    MessageStreamStatelessOptions messageStreamStatelessOptionsModel =
        new MessageStreamStatelessOptions.Builder()
            ...
            .userId("testString")
            .build();
    assertEquals(messageStreamStatelessOptionsModel.assistantId(), "testString");
    assertEquals(messageStreamStatelessOptionsModel.environmentId(), "testString");
    assertEquals(messageStreamStatelessOptionsModel.input(), messageInputModel);
    assertEquals(messageStreamStatelessOptionsModel.context(), messageContextModel);
    assertEquals(messageStreamStatelessOptionsModel.userId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testMessageStreamStatelessOptionsError() throws Throwable {
    new MessageStreamStatelessOptions.Builder().build();
  }
}
