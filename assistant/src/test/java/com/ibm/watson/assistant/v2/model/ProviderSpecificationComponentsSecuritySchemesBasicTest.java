...
/** Unit test class for the ProviderSpecificationComponentsSecuritySchemesBasic model. */
public class ProviderSpecificationComponentsSecuritySchemesBasicTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProviderSpecificationComponentsSecuritySchemesBasic() throws Throwable {
    ...
    String json = TestUtilities.serialize(providerSpecificationComponentsSecuritySchemesBasicModel);

    ProviderSpecificationComponentsSecuritySchemesBasic
        providerSpecificationComponentsSecuritySchemesBasicModelNew =
            TestUtilities.deserialize(
                json, ProviderSpecificationComponentsSecuritySchemesBasic.class);
    assertTrue(
        providerSpecificationComponentsSecuritySchemesBasicModelNew
            instanceof ProviderSpecificationComponentsSecuritySchemesBasic);
    assertEquals(
        providerSpecificationComponentsSecuritySchemesBasicModelNew.username().toString(),
