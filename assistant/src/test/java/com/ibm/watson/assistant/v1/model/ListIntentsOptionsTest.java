...
/** Unit test class for the ListIntentsOptions model. */
public class ListIntentsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListIntentsOptions() throws Throwable {
  ...
  public void testListIntentsOptionsError() throws Throwable {
    new ListIntentsOptions.Builder().build();
  }
}
