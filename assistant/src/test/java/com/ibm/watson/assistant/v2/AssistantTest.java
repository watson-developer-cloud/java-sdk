...
public class AssistantTest {
  ...
  public void testCreateSessionWOptions() throws Throwable {
    ...
    String createSessionPath = "/v2/assistants/testString/environments/testString/sessions";
    server.enqueue(
        new MockResponse()
            .setHeader("Content-type", "application/json")
            .setResponseCode(201)
  ...
  public void testDeleteSessionWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "";
    String deleteSessionPath =
        "/v2/assistants/testString/environments/testString/sessions/testString";
    server.enqueue(new MockResponse().setResponseCode(200).setBody(mockResponseBody));
  ...
  public void testMessageWOptions() throws Throwable {
    ...
    String messagePath =
        "/v2/assistants/testString/environments/testString/sessions/testString/message";
    server.enqueue(
        new MockResponse()
            .setHeader("Content-type", "application/json")
            .setResponseCode(200)
  ...
  public void testMessageStatelessWOptions() throws Throwable {
    ...
    String messageStatelessPath = "/v2/assistants/testString/environments/testString/message";
    server.enqueue(
        new MockResponse()
            .setHeader("Content-type", "application/json")
            .setResponseCode(200)
