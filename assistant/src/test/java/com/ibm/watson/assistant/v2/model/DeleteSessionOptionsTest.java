...
/** Unit test class for the DeleteSessionOptions model. */
public class DeleteSessionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteSessionOptions() throws Throwable {
  ...
  public void testDeleteSessionOptionsError() throws Throwable {
    new DeleteSessionOptions.Builder().build();
  }
}
