...
public class SearchSettingsTest {
  ...
  public void testSearchSettings() throws Throwable {
    ...
    assertEquals(
        searchSettingsModelNew.elasticSearch().toString(),
        searchSettingsElasticSearchModel.toString());
    assertEquals(
        searchSettingsModelNew.conversationalSearch().toString(),
        searchSettingsConversationalSearchModel.toString());
    assertEquals(
        searchSettingsModelNew.serverSideSearch().toString(),
        searchSettingsServerSideSearchModel.toString());
    assertEquals(
        searchSettingsModelNew.clientSideSearch().toString(),
        searchSettingsClientSideSearchModel.toString());
  }
