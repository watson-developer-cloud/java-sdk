...
/** Unit test class for the ChannelTransferInfo model. */
public class ChannelTransferInfoTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testChannelTransferInfo() throws Throwable {
    ...
    String json = TestUtilities.serialize(channelTransferInfoModel);

    ChannelTransferInfo channelTransferInfoModelNew =
        TestUtilities.deserialize(json, ChannelTransferInfo.class);
    assertTrue(channelTransferInfoModelNew instanceof ChannelTransferInfo);
    assertEquals(
        channelTransferInfoModelNew.target().toString(), channelTransferTargetModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testChannelTransferInfoError() throws Throwable {
    new ChannelTransferInfo.Builder().build();
  }
}
