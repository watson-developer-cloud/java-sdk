...
public class CreateWorkspaceOptionsTest {
  ...
  public void testCreateWorkspaceOptions() throws Throwable {
    ...
    assertEquals(createWorkspaceOptionsModel.language(), "testString");
    assertEquals(
        createWorkspaceOptionsModel.dialogNodes(), java.util.Arrays.asList(dialogNodeModel));
    assertEquals(
        createWorkspaceOptionsModel.counterexamples(),
    ...
    assertEquals(createWorkspaceOptionsModel.intents(), java.util.Arrays.asList(createIntentModel));
    assertEquals(
        createWorkspaceOptionsModel.entities(), java.util.Arrays.asList(createEntityModel));
    assertEquals(createWorkspaceOptionsModel.includeAudit(), Boolean.valueOf(false));
  }
}
