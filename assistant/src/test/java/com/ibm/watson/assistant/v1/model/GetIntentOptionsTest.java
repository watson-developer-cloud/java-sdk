...
/** Unit test class for the GetIntentOptions model. */
public class GetIntentOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetIntentOptions() throws Throwable {
  ...
  public void testGetIntentOptionsError() throws Throwable {
    new GetIntentOptions.Builder().build();
  }
}
