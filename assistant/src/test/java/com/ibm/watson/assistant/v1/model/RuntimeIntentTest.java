...
/** Unit test class for the RuntimeIntent model. */
public class RuntimeIntentTest {
  ...
  public void testRuntimeIntent() throws Throwable {
    ...
    RuntimeIntent runtimeIntentModelNew = TestUtilities.deserialize(json, RuntimeIntent.class);
  ...
  public void testRuntimeIntentError() throws Throwable {
    new RuntimeIntent.Builder().build();
  }
}
