...
/** Unit test class for the DialogNodeOutputOptionsElementValue model. */
public class DialogNodeOutputOptionsElementValueTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDialogNodeOutputOptionsElementValue() throws Throwable {
    ...
    String json = TestUtilities.serialize(dialogNodeOutputOptionsElementValueModel);

    DialogNodeOutputOptionsElementValue dialogNodeOutputOptionsElementValueModelNew =
        TestUtilities.deserialize(json, DialogNodeOutputOptionsElementValue.class);
    assertTrue(
        dialogNodeOutputOptionsElementValueModelNew instanceof DialogNodeOutputOptionsElementValue);
    assertEquals(
        dialogNodeOutputOptionsElementValueModelNew.input().toString(),
        messageInputModel.toString());
  }
}
