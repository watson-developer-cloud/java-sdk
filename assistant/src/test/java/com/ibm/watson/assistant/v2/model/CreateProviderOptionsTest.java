...
/** Unit test class for the CreateProviderOptions model. */
public class CreateProviderOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateProviderOptions() throws Throwable {
    ...
    CreateProviderOptions createProviderOptionsModel =
        new CreateProviderOptions.Builder()
            ...
            .build();
    assertEquals(createProviderOptionsModel.providerId(), "testString");
    assertEquals(createProviderOptionsModel.specification(), providerSpecificationModel);
    assertEquals(createProviderOptionsModel.xPrivate(), providerPrivateModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateProviderOptionsError() throws Throwable {
    new CreateProviderOptions.Builder().build();
  }
}
