...
/** Unit test class for the RuntimeResponseGenericRuntimeResponseTypeSearch model. */
public class RuntimeResponseGenericRuntimeResponseTypeSearchTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRuntimeResponseGenericRuntimeResponseTypeSearch() throws Throwable {
    ...
    assertNull(runtimeResponseGenericRuntimeResponseTypeSearchModel.channels());
  }
}
