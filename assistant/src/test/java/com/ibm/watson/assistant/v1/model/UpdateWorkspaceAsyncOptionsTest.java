...
/** Unit test class for the UpdateWorkspaceAsyncOptions model. */
public class UpdateWorkspaceAsyncOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateWorkspaceAsyncOptions() throws Throwable {
    ...
    UpdateWorkspaceAsyncOptions updateWorkspaceAsyncOptionsModel =
        new UpdateWorkspaceAsyncOptions.Builder()
            ...
            .append(false)
            .build();
    assertEquals(updateWorkspaceAsyncOptionsModel.workspaceId(), "testString");
    assertEquals(updateWorkspaceAsyncOptionsModel.name(), "testString");
    assertEquals(updateWorkspaceAsyncOptionsModel.description(), "testString");
    assertEquals(updateWorkspaceAsyncOptionsModel.language(), "testString");
    assertEquals(
        updateWorkspaceAsyncOptionsModel.dialogNodes(), java.util.Arrays.asList(dialogNodeModel));
    assertEquals(
        updateWorkspaceAsyncOptionsModel.counterexamples(),
        java.util.Arrays.asList(counterexampleModel));
    assertEquals(
        updateWorkspaceAsyncOptionsModel.metadata(),
        java.util.Collections.singletonMap("anyKey", "anyValue"));
    assertEquals(updateWorkspaceAsyncOptionsModel.learningOptOut(), Boolean.valueOf(false));
    assertEquals(updateWorkspaceAsyncOptionsModel.systemSettings(), workspaceSystemSettingsModel);
    assertEquals(
        updateWorkspaceAsyncOptionsModel.webhooks(), java.util.Arrays.asList(webhookModel));
    assertEquals(
        updateWorkspaceAsyncOptionsModel.intents(), java.util.Arrays.asList(createIntentModel));
    assertEquals(
        updateWorkspaceAsyncOptionsModel.entities(), java.util.Arrays.asList(createEntityModel));
    assertEquals(updateWorkspaceAsyncOptionsModel.append(), Boolean.valueOf(false));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateWorkspaceAsyncOptionsError() throws Throwable {
    new UpdateWorkspaceAsyncOptions.Builder().build();
  }
}
