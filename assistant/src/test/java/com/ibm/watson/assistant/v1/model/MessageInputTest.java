...
public class MessageInputTest {
  ...
  public void testMessageInput() throws Throwable {
    ...
    assertEquals(messageInputModelNew.isSpellingSuggestions(), Boolean.valueOf(false));
    assertEquals(messageInputModelNew.isSpellingAutoCorrect(), Boolean.valueOf(false));
