...
/** Unit test class for the DialogSuggestionValue model. */
public class DialogSuggestionValueTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDialogSuggestionValue() throws Throwable {
    ...
    String json = TestUtilities.serialize(dialogSuggestionValueModel);

    DialogSuggestionValue dialogSuggestionValueModelNew =
        TestUtilities.deserialize(json, DialogSuggestionValue.class);
    assertTrue(dialogSuggestionValueModelNew instanceof DialogSuggestionValue);
    assertEquals(dialogSuggestionValueModelNew.input().toString(), messageInputModel.toString());
  }
}
