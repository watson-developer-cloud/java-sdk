...
/** Unit test class for the ImportSkillsOptions model. */
public class ImportSkillsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testImportSkillsOptions() throws Throwable {
    ...
    assertEquals(assistantStateModel.actionDisabled(), Boolean.valueOf(true));
    assertEquals(assistantStateModel.dialogDisabled(), Boolean.valueOf(true));
    ...
    ImportSkillsOptions importSkillsOptionsModel =
        new ImportSkillsOptions.Builder()
            ...
            .includeAudit(false)
            .build();
    assertEquals(importSkillsOptionsModel.assistantId(), "testString");
    assertEquals(
        importSkillsOptionsModel.assistantSkills(), java.util.Arrays.asList(skillImportModel));
    assertEquals(importSkillsOptionsModel.assistantState(), assistantStateModel);
    assertEquals(importSkillsOptionsModel.includeAudit(), Boolean.valueOf(false));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testImportSkillsOptionsError() throws Throwable {
    new ImportSkillsOptions.Builder().build();
  }
}
