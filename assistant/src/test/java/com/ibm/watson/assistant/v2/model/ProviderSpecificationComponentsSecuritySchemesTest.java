...
/** Unit test class for the ProviderSpecificationComponentsSecuritySchemes model. */
public class ProviderSpecificationComponentsSecuritySchemesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProviderSpecificationComponentsSecuritySchemes() throws Throwable {
    ...
    String json = TestUtilities.serialize(providerSpecificationComponentsSecuritySchemesModel);

    ProviderSpecificationComponentsSecuritySchemes
        providerSpecificationComponentsSecuritySchemesModelNew =
            TestUtilities.deserialize(json, ProviderSpecificationComponentsSecuritySchemes.class);
    assertTrue(
        providerSpecificationComponentsSecuritySchemesModelNew
            instanceof ProviderSpecificationComponentsSecuritySchemes);
    assertEquals(
        providerSpecificationComponentsSecuritySchemesModelNew.authenticationMethod(), "basic");
    assertEquals(
        providerSpecificationComponentsSecuritySchemesModelNew.basic().toString(),
        providerSpecificationComponentsSecuritySchemesBasicModel.toString());
    assertEquals(
        providerSpecificationComponentsSecuritySchemesModelNew.oauth2().toString(),
        providerAuthenticationOAuth2Model.toString());
  }
}
