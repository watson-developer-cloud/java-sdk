...
public class MessageResponse extends GenericModel {
     ...
     *
     * @return a map of objects representing the response from the Dialog
    ...
    /**
     * A convenience method for getting the text property from the output
    ...
    /**
     * A convenience method for getting the text property from the output
     * object. The text property is an array of strings. This convenience class
