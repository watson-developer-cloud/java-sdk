...
public final class ConversationService extends WatsonService {
   ...
   */
  public ServiceCall<CounterexampleCollectionResponse> listCounterexamples(String workspaceId, Double pageLimit,
    ...
    builder.query(VERSION, versionDate);
    if (pageLimit != null) {
      builder.query("page_limit", pageLimit.toString());
    }
    if (includeCount != null) {
      builder.query("include_count", includeCount.toString());
    }
    if (sort != null) {
   ...
   * @return the {@link ExampleResponse} with the response
   */
  public ServiceCall<ExampleResponse> updateCounterexample(String workspaceId, String text, UpdateExample body) {
    Validator.notNull(workspaceId, "workspaceId cannot be null");
    Validator.notNull(text, "text cannot be null");
   ...
   */
  public ServiceCall<ExampleCollectionResponse> listExamples(String workspaceId, String intent, Double pageLimit,
   ...
   * @return the {@link ExampleResponse} with the response
   */
  public ServiceCall<ExampleResponse> updateExample(String workspaceId, String intent, String text, UpdateExample
      body) {
    Validator.notNull(workspaceId, "workspaceId cannot be null");
    Validator.notNull(intent, "intent cannot be null");
    Validator.notNull(text, "text cannot be null");
   ...
   *              data includes only information about the element itself. If export=`true`, all content, including
   *              subelements, is included. The default value is `false`.
  ...
  public ServiceCall<IntentExportResponse> getIntent(String workspaceId, String intent, Boolean export) {
    ...
    builder.query(VERSION, versionDate);
    if (export != null) {
      builder.query("export", export.toString());
    }
   ...
   *
   * @param workspaceId:  The workspace ID.
   * @param export:       Whether to include all element content in the returned data. If export=`false`, the
   ...
   */
  public ServiceCall<IntentCollectionResponse> listIntents(String workspaceId, Boolean export, Double pageLimit,
                                                           Boolean includeCount, String sort, String cursor) {
    Validator.notNull(workspaceId, "workspaceId cannot be null");
   ...
   * @return the {@link IntentResponse} with the response
   */
  public ServiceCall<IntentResponse> updateIntent(String workspaceId, String intent, UpdateIntent body) {
    Validator.notNull(workspaceId, "workspaceId cannot be null");
    Validator.notNull(intent, "intent cannot be null");
    Validator.notNull(body, "body cannot be null");
   ...
   */
  public ServiceCall<WorkspaceCollectionResponse> listWorkspaces(Double pageLimit, Boolean includeCount, String sort,
                                                                 String cursor) {
