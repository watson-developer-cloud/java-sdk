...
public class MessageRequest extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Sets the context/state which is to be sent to the message API as a part
     * of the service request. Each response from the message API returns a
     * <code>context</code> object which represents the state as defined by the
     * service. The state is not maintained by the service, so the client must
     * keep the state from each API call, and pass that state in as a part of
     * any subsequent requests.
     *
     * @param context
     *          a map containing key value pairs representing the state/context
     *          of the conversation
     *
     * @return a builder object
     */
    ...
    /**
     * Sets the input which is to be sent to the message API as a part of the
     * service request. Typically the input will contain a <code>text</code>
     * property (key and value). The <code>text</code> property is generally
     * interpreted as being the user/system input which the service must parse
     * for intents, entities etc..<br>
     * In advanced cases the client may pass in more than just text as a part of
     * the service input. For the majority of cases calling the
     * {@link #inputText(String)} method is sufficient to send text to the
     * service on behalf of the user/system.
     *
     * @param input
     *          a map of properties to be sent to the service under the input
     *          property
     * @return a builder object
     */
    ...
    /**
     * Sets the input text which is to be sent to the message API as a part of
     * the service request.
     *
     * @param text
     *          the textual value to be assigned to the 'text' property on the
     *          input object.
     * @return a builder object
     */
   ...
   * response from the message API will return a context object as a part of the
   * payload. This context must be maintained and passed in as a part of
