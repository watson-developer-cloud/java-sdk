...
public class ContentItemTest {
  ...
  public void testContentItem() throws Throwable {
    ...
    assertEquals(contentItemModelNew.language(), "en");
    assertEquals(contentItemModelNew.parentid(), "testString");
    assertEquals(contentItemModelNew.reply(), Boolean.valueOf(false));
    assertEquals(contentItemModelNew.forward(), Boolean.valueOf(false));
  }
