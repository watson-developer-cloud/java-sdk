...
public class PersonalityInsights extends WatsonService {
   ...
   * much less text to produce an accurate profile; for more information, see [Providing sufficient input]
   * (https://console.bluemix.net/docs/services/personality-insights/input.html#sufficient). Accepts input in Arabic,
   * English, Japanese, Korean, or Spanish and produces output in one of eleven languages. Provide plain text, HTML,
   * or JSON content, and receive results in JSON or CSV format.
   *
