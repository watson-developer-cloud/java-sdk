...
public class ConsumptionPreferences extends GenericModel {
   ...
   * some preferences are binary and do not allow a neutral value. The score is an indication of preference based on
   * the results inferred from the input text, not a normalized percentile.
   *
   * @return the score
   */
