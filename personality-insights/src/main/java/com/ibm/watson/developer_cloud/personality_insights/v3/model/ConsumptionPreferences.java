...
public class ConsumptionPreferences extends GenericModel {
   ...
   * Gets the score.
   *
   * The score for the consumption preference: `0.0` indicates unlikely, `0.5` indicates neutrality, and `1.0` indicates
   * likely. The scores for some preferences are binary and do not allow a neutral value. The score is an indication of
