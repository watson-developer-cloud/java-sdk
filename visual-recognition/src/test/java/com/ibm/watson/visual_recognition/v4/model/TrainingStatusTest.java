...
public class TrainingStatusTest {
  ...
  public void testTrainingStatus() throws Throwable {
    ...
    String json = TestUtilities.serialize(trainingStatusModel);

    TrainingStatus trainingStatusModelNew = TestUtilities.deserialize(json, TrainingStatus.class);
    assertTrue(trainingStatusModelNew instanceof TrainingStatus);
    assertEquals(trainingStatusModelNew.objects().toString(), objectTrainingStatusModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testTrainingStatusError() throws Throwable {
    new TrainingStatus.Builder().build();
  }
}
