...
/** Unit test class for the ListClassifiersOptions model. */
public class ListClassifiersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListClassifiersOptions() throws Throwable {
    ListClassifiersOptions listClassifiersOptionsModel =
        new ListClassifiersOptions.Builder().verbose(true).build();
    assertEquals(listClassifiersOptionsModel.verbose(), Boolean.valueOf(true));
  }
}
