  ...
  public void testAnalyzeOptions() throws Throwable {
    AnalyzeOptions analyzeOptionsModel =
        new AnalyzeOptions.Builder()
            ...
            .build();
    assertEquals(
        analyzeOptionsModel.collectionIds(),
        new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(
        analyzeOptionsModel.features(),
        new java.util.ArrayList<String>(java.util.Arrays.asList("objects")));
    assertEquals(analyzeOptionsModel.imagesFile(), mockListFileWithMetadata);
    assertEquals(
        analyzeOptionsModel.imageUrl(),
        new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(analyzeOptionsModel.threshold(), Float.valueOf("0.15"));
  }
