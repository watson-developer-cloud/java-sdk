...
public class Validate {
   ...
   * is <code>null</code> or has elements that are not of type <code>clazz</code> or a subclass.
   * </p>
   * 
   * <pre>
   ...
   * elements that are <code>null</code>; otherwise throwing an exception.
   * 
   * <pre>
   ...
   * <p>
   * Validate that the specified argument collection is neither <code>null</code> nor contains any
   * elements that are <code>null</code>; otherwise throwing an exception with the specified
   * message.
   * 
   * <pre>
  ...
  public static void noNullElements(Object[] array) {
    ...
    for (int i = 0; i < array.length; i++) {
      if (array[i] == null) {
        throw new IllegalArgumentException("The validated array contains null element at index: "
            + i);
      }
    }
  }
