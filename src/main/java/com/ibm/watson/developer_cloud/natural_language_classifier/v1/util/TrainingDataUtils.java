...
public class TrainingDataUtils {
  ...
  public static List<TrainingData> fromCSV(final File file, CSVFormat format) {
    ...
    final List<TrainingData> trainingData = new ArrayList<TrainingData>();
  ...
  public static String toCSV(final TrainingData... data) {
    ...
    try {
      final CSVPrinter printer = new CSVPrinter(stringWriter, CSVFormat.EXCEL);
      for (final TrainingData trainingData : data) {
