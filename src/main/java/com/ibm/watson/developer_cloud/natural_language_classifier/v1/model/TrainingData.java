...
public class TrainingData extends GenericModel {
  ...
  /**
   * Gets the representative phrase. For example, questions that users might ask
   * 
   * @return the phrase
   */
  ...
  /**
   * Sets the representative phrase. For example, questions that users might ask
   * 
   * @param text the new phrase
   */
