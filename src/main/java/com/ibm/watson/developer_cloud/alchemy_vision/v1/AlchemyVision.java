...
public class AlchemyVision extends AlchemyService {
	 ...
	 * 
	 * @param params
	 *            The parameters to be used in the service call, html or url should
	 *            be specified.
	 ...
	 * 
	 * @param params
	 *            The parameters to be used in the service call, image or url should
	 *            be specified.
	 * @return {@link ImageKeywords}
	 */
	public ImageKeywords getImageKeywords(Map<String, Object> params) {
		return executeRequest(params, AlchemyAPI.image_recognition,ImageKeywords.class);
	}
	...
	private <T> T executeRequest(Map<String, Object> params, AlchemyAPI operation, Class<T> returnType) {
		...
		if (params.get(IMAGE_POST_MODE).equals(RAW)) {
