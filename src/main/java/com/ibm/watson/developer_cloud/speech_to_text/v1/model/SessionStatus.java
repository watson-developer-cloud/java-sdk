...
public class SessionStatus {
	 ...
	 * @return the session
	 */
	public SessionStatus withModel(String model) {
		this.model = model;
		return this;
	}
	 ...
	 * @return the session
	 */
	public SessionStatus withRecognize(String recognize) {
		this.recognize = recognize;
		return this;
	}
	 ...
	 */
	public SessionStatus withObserveResult(String observeResult) {
		this.observeResult = observeResult;
		return this;
	}
