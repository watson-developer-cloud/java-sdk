...
/**
 * This class contains the parameters when using {@link SpeechToText#createRecognitionJob(java.io.File, RecognizeOptions, RecognitionJobOptions)}.
 * 
 * @see SpeechToText
 */
public class RecognitionJobOptions {
  ...
  public static class Builder {
    ...
    public Builder(RecognitionJobOptions options) {
      ...
      this.resultsTtl = options.resultsTtl;
