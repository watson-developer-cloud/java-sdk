...
public class Article extends GenericModel {
	 ...
	 * With enriched title.
	 *
	 * @param enrichedTitle the enriched title
	 * @return the article
	 */
	public Article withEnrichedTitle(EnrichedTitle enrichedTitle) {
		this.enrichedTitle = enrichedTitle;
		return this;
	}
	 ...
	 * @return the article
	 */
	public Article withPublicationDate(PublicationDate publicationDate) {
		this.publicationDate = publicationDate;
		return this;
	}
