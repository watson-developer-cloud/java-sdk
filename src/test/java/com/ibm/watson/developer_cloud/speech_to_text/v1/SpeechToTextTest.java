...
public class SpeechToTextTest extends WatsonServiceUnitTest {
  ...
  private final static String PATH_CREATE_DELETE_SESSIONS = "/v1/sessions";
  private final static String PATH_GET_MODELS = "/v1/models";
  private final static String PATH_RECOGNIZE = "/v1/recognize";
