...
public class TrainingDataUtilsTest {
  ...
  /**
   * Test illegal argument exception file null.
   */
  ...
  public void testToCSV() {
    Assert.assertEquals("foo,class1,class2,class3\r\nfoo2,class3\r\nfoo3,class3\r\n",
        TrainingDataUtils.toCSV(
            new TrainingData().withText("foo").withClasses("class1", "class2", "class3"),
            new TrainingData().withText("foo2").withClasses("class3"),
            new TrainingData().withText("foo3").withClasses("class3"),
            new TrainingData().withText("foo4"), new TrainingData().withClasses("class4")));
  }
  ...
  public void testToTrainingData() {
    final File file = new File("src/test/resources/weather_data_train.csv");
    final List<TrainingData> trainingData = TrainingDataUtils.fromCSV(file, CSVFormat.DEFAULT);
