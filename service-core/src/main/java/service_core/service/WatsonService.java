...
import service_core.http.HttpStatus;
...
import service_core.service.exception.BadRequestException;
import service_core.service.exception.ConflictException;
import service_core.service.exception.ForbiddenException;
import service_core.service.exception.InternalServerErrorException;
import service_core.service.exception.NotFoundException;
import service_core.service.exception.RequestTooLargeException;
import service_core.service.exception.ServiceResponseException;
import service_core.service.exception.ServiceUnavailableException;
import service_core.service.exception.TooManyRequestsException;
import service_core.service.exception.UnauthorizedException;
import service_core.service.exception.UnsupportedException;
import service_core.util.CredentialUtils;
import service_core.util.RequestUtils;
...
public abstract class WatsonService {
  ...
  private static final String PATH_AUTHORIZATION_V1_TOKEN = "/watson.developer_cloud.retrieve_and_rank.v1/token";
