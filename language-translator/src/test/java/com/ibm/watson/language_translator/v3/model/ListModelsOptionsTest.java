  ...
  public void testListModelsOptions() throws Throwable {
    ListModelsOptions listModelsOptionsModel =
        new ListModelsOptions.Builder()
            ...
            .xDefault(true)
            .build();
    assertEquals(listModelsOptionsModel.source(), "testString");
    assertEquals(listModelsOptionsModel.target(), "testString");
    assertEquals(listModelsOptionsModel.xDefault(), Boolean.valueOf(true));
  }
}
