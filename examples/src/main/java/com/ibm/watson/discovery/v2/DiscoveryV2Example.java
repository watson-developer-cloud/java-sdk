...
public class DiscoveryV2Example {
  ...
  public static void main(String[] args) throws IOException {
    ...
    // This example assumes you have a project and collection set up which can accept documents. Paste those
    // IDs below.
    String projectId = "";
    String collectionId = "";
    ...
    AddDocumentOptions addDocumentOptions = new AddDocumentOptions.Builder()
        ...
        //.fileContentType(HttpMediaType.APPLICATION_PDF) // Fill in the content type of your chosen file here!
        .build();
    ...
    QueryOptions queryOptoins = new QueryOptions.Builder()
        .projectId(projectId)
        .addCollectionIds(collectionId)
        .naturalLanguageQuery("Watson") // Feel free to replace this to query something different.
        .build();
