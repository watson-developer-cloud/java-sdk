...
public class ResizeASolrClusterExample {
    public static void main(String[] args) throws InterruptedException {
        ...
        final SolrClusters clusters = service.getSolrClusters().execute();
        for (final SolrCluster cluster : clusters.getSolrClusters()) {
            service.deleteSolrCluster(cluster.getId());
        }
