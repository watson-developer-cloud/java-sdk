...
public class ClassifyOptionsTest {
  ...
  public void testClassifyOptions() throws Throwable {
    ...
    assertEquals(classifyOptionsModel.classifierId(), "testString");
    assertEquals(classifyOptionsModel.text(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testClassifyOptionsError() throws Throwable {
    new ClassifyOptions.Builder().build();
  }
}
