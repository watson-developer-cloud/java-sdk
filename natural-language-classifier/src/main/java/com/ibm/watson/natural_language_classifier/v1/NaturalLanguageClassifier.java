...
/**
 * IBM Watson&trade; Natural Language Classifier uses machine learning algorithms to return the top
 * matching predefined classes for short text input. You create and train a classifier to connect
