...
public class CustomModels extends GenericModel {
   ...
   *
   * <p>An array of `CustomModel` objects that provides information about each available custom
   * model. The array is empty if the requesting credentials own no custom models (if no language is
