...
public class DeleteSpeakerModelOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteSpeakerModelOptions instance.
     *
     * @param deleteSpeakerModelOptions the instance to initialize the Builder with
     */
  ...
  protected DeleteSpeakerModelOptions() {}
