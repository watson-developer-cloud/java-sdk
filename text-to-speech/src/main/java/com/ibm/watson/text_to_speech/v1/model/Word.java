...
public class Word extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing Word instance.
     *
     * @param word the instance to initialize the Builder with
     */
   ...
   * like the word. The maximum length of a translation is 499 characters.
   *
