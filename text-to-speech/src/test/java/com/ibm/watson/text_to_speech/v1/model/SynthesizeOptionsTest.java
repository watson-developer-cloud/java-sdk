...
/** Unit test class for the SynthesizeOptions model. */
public class SynthesizeOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSynthesizeOptions() throws Throwable {
  ...
  public void testSynthesizeOptionsError() throws Throwable {
    new SynthesizeOptions.Builder().build();
  }
}
