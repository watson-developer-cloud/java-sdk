...
public class ListTrainingQueriesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListTrainingQueriesOptions instance.
     *
     * @param listTrainingQueriesOptions the instance to initialize the Builder with
     */
    private Builder(ListTrainingQueriesOptions listTrainingQueriesOptions) {
      this.projectId = listTrainingQueriesOptions.projectId;
    }
  ...
  protected ListTrainingQueriesOptions(Builder builder) {
