...
/**
  ...
  public ServiceCall<CollectionDetails> createCollection(CreateCollectionOptions createCollectionOptions) {
    ...
    ResponseConverter<CollectionDetails> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<CollectionDetails>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
  ...
  public ServiceCall<CollectionDetails> getCollection(GetCollectionOptions getCollectionOptions) {
    ...
    String[] pathSegments = { "v2/projects", "collections" };
    String[] pathParameters = { getCollectionOptions.projectId(), getCollectionOptions.collectionId() };
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.constructHttpUrl(getServiceUrl(), pathSegments, pathParameters));
    builder.query("version", versionDate);
  ...
  public ServiceCall<CollectionDetails> updateCollection(UpdateCollectionOptions updateCollectionOptions) {
    ...
    String[] pathSegments = { "v2/projects", "collections" };
    String[] pathParameters = { updateCollectionOptions.projectId(), updateCollectionOptions.collectionId() };
    RequestBuilder builder = RequestBuilder.post(RequestBuilder.constructHttpUrl(getServiceUrl(), pathSegments, pathParameters));
    builder.query("version", versionDate);
  ...
  public ServiceCall<Void> deleteCollection(DeleteCollectionOptions deleteCollectionOptions) {
    ...
    String[] pathSegments = { "v2/projects", "collections" };
    String[] pathParameters = { deleteCollectionOptions.projectId(), deleteCollectionOptions.collectionId() };
  ...
  public ServiceCall<ListFieldsResponse> listFields(ListFieldsOptions listFieldsOptions) {
    ...
    ResponseConverter<ListFieldsResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<ListFieldsResponse>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
  ...
  public ServiceCall<ComponentSettingsResponse> getComponentSettings(GetComponentSettingsOptions getComponentSettingsOptions) {
    ...
    ResponseConverter<ComponentSettingsResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<ComponentSettingsResponse>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
  ...
  public ServiceCall<DocumentAccepted> updateDocument(UpdateDocumentOptions updateDocumentOptions) {
    ...
    String[] pathSegments = { "v2/projects", "collections", "documents" };
    String[] pathParameters = { updateDocumentOptions.projectId(), updateDocumentOptions.collectionId(), updateDocumentOptions.documentId() };
    RequestBuilder builder = RequestBuilder.post(RequestBuilder.constructHttpUrl(getServiceUrl(), pathSegments, pathParameters));
    builder.query("version", versionDate);
  ...
  public ServiceCall<DeleteDocumentResponse> deleteDocument(DeleteDocumentOptions deleteDocumentOptions) {
    ...
    String[] pathSegments = { "v2/projects", "collections", "documents" };
    String[] pathParameters = { deleteDocumentOptions.projectId(), deleteDocumentOptions.collectionId(), deleteDocumentOptions.documentId() };
    RequestBuilder builder = RequestBuilder.delete(RequestBuilder.constructHttpUrl(getServiceUrl(), pathSegments, pathParameters));
    builder.query("version", versionDate);
  ...
  public ServiceCall<TrainingQuerySet> listTrainingQueries(ListTrainingQueriesOptions listTrainingQueriesOptions) {
    ...
    ResponseConverter<TrainingQuerySet> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<TrainingQuerySet>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   *
   * @param listEnrichmentsOptions the {@link ListEnrichmentsOptions} containing the options for the call
  ...
  public ServiceCall<Enrichments> listEnrichments(ListEnrichmentsOptions listEnrichmentsOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(listEnrichmentsOptions,
      "listEnrichmentsOptions cannot be null");
    ...
    ResponseConverter<Enrichments> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<Enrichments>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   *
   * @param createEnrichmentOptions the {@link CreateEnrichmentOptions} containing the options for the call
  ...
  public ServiceCall<Enrichment> createEnrichment(CreateEnrichmentOptions createEnrichmentOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(createEnrichmentOptions,
      "createEnrichmentOptions cannot be null");
    String[] pathSegments = { "v2/projects", "enrichments" };
    ...
    ResponseConverter<Enrichment> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<Enrichment>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   *
   * @param getEnrichmentOptions the {@link GetEnrichmentOptions} containing the options for the call
   * @return a {@link ServiceCall} with a response type of {@link Enrichment}
   */
  public ServiceCall<Enrichment> getEnrichment(GetEnrichmentOptions getEnrichmentOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(getEnrichmentOptions,
      "getEnrichmentOptions cannot be null");
    String[] pathSegments = { "v2/projects", "enrichments" };
    String[] pathParameters = { getEnrichmentOptions.projectId(), getEnrichmentOptions.enrichmentId() };
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.constructHttpUrl(getServiceUrl(), pathSegments, pathParameters));
    builder.query("version", versionDate);
   ...
   *
   * @param updateEnrichmentOptions the {@link UpdateEnrichmentOptions} containing the options for the call
   * @return a {@link ServiceCall} with a response type of {@link Enrichment}
   */
  public ServiceCall<Enrichment> updateEnrichment(UpdateEnrichmentOptions updateEnrichmentOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(updateEnrichmentOptions,
      "updateEnrichmentOptions cannot be null");
    String[] pathSegments = { "v2/projects", "enrichments" };
    String[] pathParameters = { updateEnrichmentOptions.projectId(), updateEnrichmentOptions.enrichmentId() };
    RequestBuilder builder = RequestBuilder.post(RequestBuilder.constructHttpUrl(getServiceUrl(), pathSegments, pathParameters));
    builder.query("version", versionDate);
   ...
   *
   * @param deleteEnrichmentOptions the {@link DeleteEnrichmentOptions} containing the options for the call
   * @return a {@link ServiceCall} with a response type of Void
   */
  public ServiceCall<Void> deleteEnrichment(DeleteEnrichmentOptions deleteEnrichmentOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(deleteEnrichmentOptions,
      "deleteEnrichmentOptions cannot be null");
    String[] pathSegments = { "v2/projects", "enrichments" };
    String[] pathParameters = { deleteEnrichmentOptions.projectId(), deleteEnrichmentOptions.enrichmentId() };
    RequestBuilder builder = RequestBuilder.delete(RequestBuilder.constructHttpUrl(getServiceUrl(), pathSegments, pathParameters));
    builder.query("version", versionDate);
  ...
  public ServiceCall<ListProjectsResponse> listProjects(ListProjectsOptions listProjectsOptions) {
    ...
    ResponseConverter<ListProjectsResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<ListProjectsResponse>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
  ...
  public ServiceCall<ProjectDetails> createProject(CreateProjectOptions createProjectOptions) {
    ...
    ResponseConverter<ProjectDetails> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<ProjectDetails>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   *
   * @param updateProjectOptions the {@link UpdateProjectOptions} containing the options for the call
   * @return a {@link ServiceCall} with a response type of {@link ProjectDetails}
   */
  public ServiceCall<ProjectDetails> updateProject(UpdateProjectOptions updateProjectOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(updateProjectOptions,
      "updateProjectOptions cannot be null");
    String[] pathSegments = { "v2/projects" };
