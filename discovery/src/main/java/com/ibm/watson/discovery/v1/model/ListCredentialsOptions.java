...
public class ListCredentialsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListCredentialsOptions instance.
     *
     * @param listCredentialsOptions the instance to initialize the Builder with
     */
  ...
  protected ListCredentialsOptions() {}

  protected ListCredentialsOptions(Builder builder) {
