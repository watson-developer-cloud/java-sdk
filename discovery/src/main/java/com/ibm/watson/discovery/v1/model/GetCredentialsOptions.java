...
public class GetCredentialsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetCredentialsOptions instance.
     *
     * @param getCredentialsOptions the instance to initialize the Builder with
     */
     ...
     *
     * @return the new GetCredentialsOptions instance
     */
  ...
  protected GetCredentialsOptions() {}
