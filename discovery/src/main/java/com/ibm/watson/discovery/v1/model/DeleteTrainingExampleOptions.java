...
public class DeleteTrainingExampleOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteTrainingExampleOptions instance.
     *
     * @param deleteTrainingExampleOptions the instance to initialize the Builder with
     */
