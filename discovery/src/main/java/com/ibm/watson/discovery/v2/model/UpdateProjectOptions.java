...
public class UpdateProjectOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateProjectOptions instance.
     *
     * @param updateProjectOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateProjectOptions() {}
