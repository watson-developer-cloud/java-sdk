...
public class DeleteEnvironmentOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteEnvironmentOptions instance.
     *
     * @param deleteEnvironmentOptions the instance to initialize the Builder with
     */
  ...
  protected DeleteEnvironmentOptions() {}
