...
public class QueryLogOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing QueryLogOptions instance.
     *
     * @param queryLogOptions the instance to initialize the Builder with
     */
