...
public class QueryResultPassage extends GenericModel {
   ...
   * Gets the answers.
   *
   * <p>An arry of extracted answers to the specified query. Returned for natural language queries
   * when **passages.per_document** is `true`.
   *
   * @return the answers
   */
