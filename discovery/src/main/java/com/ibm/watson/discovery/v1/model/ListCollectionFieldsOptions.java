...
public class ListCollectionFieldsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ListCollectionFieldsOptions instance.
     *
     * @param listCollectionFieldsOptions the instance to initialize the Builder with
     */
