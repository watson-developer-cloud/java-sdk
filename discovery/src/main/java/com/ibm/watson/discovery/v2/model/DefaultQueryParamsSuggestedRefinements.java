...
public class DefaultQueryParamsSuggestedRefinements extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DefaultQueryParamsSuggestedRefinements instance.
     *
     * @param defaultQueryParamsSuggestedRefinements the instance to initialize the Builder with
     */
