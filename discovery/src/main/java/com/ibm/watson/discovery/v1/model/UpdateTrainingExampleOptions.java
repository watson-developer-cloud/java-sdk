...
public class UpdateTrainingExampleOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateTrainingExampleOptions instance.
     *
     * @param updateTrainingExampleOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateTrainingExampleOptions() {}
