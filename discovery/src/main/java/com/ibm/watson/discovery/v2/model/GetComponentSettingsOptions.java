...
public class GetComponentSettingsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetComponentSettingsOptions instance.
     *
     * @param getComponentSettingsOptions the instance to initialize the Builder with
     */
  ...
  protected GetComponentSettingsOptions() {}
