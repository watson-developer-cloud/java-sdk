...
public class NormalizationOperation extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing NormalizationOperation instance.
     *
     * @param normalizationOperation the instance to initialize the Builder with
     */
  ...
  protected NormalizationOperation() {}
