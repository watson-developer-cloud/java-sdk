...
public class DeleteTrainingDataOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteTrainingDataOptions instance.
     *
     * @param deleteTrainingDataOptions the instance to initialize the Builder with
     */
     ...
     *
     * @return the new DeleteTrainingDataOptions instance
     */
  ...
  protected DeleteTrainingDataOptions() {}
