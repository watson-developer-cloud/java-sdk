...
public class DeleteAllTrainingDataOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteAllTrainingDataOptions instance.
     *
     * @param deleteAllTrainingDataOptions the instance to initialize the Builder with
     */
  ...
  protected DeleteAllTrainingDataOptions() {}

  protected DeleteAllTrainingDataOptions(Builder builder) {
