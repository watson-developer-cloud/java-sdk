...
public class GetTokenizationDictionaryStatusOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetTokenizationDictionaryStatusOptions instance.
     *
     * @param getTokenizationDictionaryStatusOptions the instance to initialize the Builder with
     */
  ...
  protected GetTokenizationDictionaryStatusOptions() {}
