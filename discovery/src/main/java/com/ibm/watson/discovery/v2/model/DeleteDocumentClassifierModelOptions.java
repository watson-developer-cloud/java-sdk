...
public class DeleteDocumentClassifierModelOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteDocumentClassifierModelOptions instance.
     *
     * @param deleteDocumentClassifierModelOptions the instance to initialize the Builder with
     */
