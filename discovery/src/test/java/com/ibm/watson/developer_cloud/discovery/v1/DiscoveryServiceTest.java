...
public class DiscoveryServiceTest extends WatsonServiceUnitTest {
  ...
  private static final String COLL3_PATH = "/v1/environments/mock_envid/collections/mock_collid/fields?version="
      + VERSION;
  private static final String DOCS1_PATH = "/v1/environments/mock_envid/collections/mock_collid/documents?version="
      + VERSION;
  private static final String DOCS2_PATH = "/v1/environments/mock_envid/collections/mock_collid/documents/mock_docid?version="
      + VERSION;
  ...
  private static final String Q5_PATH = "/v1/environments/mock_envid/collections/mock_collid/notices?version="
      + VERSION;
  private static final String TRAINING1_PATH = "/v1/environments/mock_envid/collections/mock_collid/training_data?version="
      + VERSION;
  private static final String TRAINING2_PATH = "/v1/environments/mock_envid/collections/mock_collid/training_data/mock_queryid/examples?version="
      + VERSION;
  private static final String TRAINING3_PATH = "/v1/environments/mock_envid/collections/mock_collid/training_data/mock_queryid?version="
      + VERSION;
  private static final String TRAINING4_PATH = "/v1/environments/mock_envid/collections/mock_collid/training_data/mock_queryid/examples/mock_docid?version="
      + VERSION;
  private static final String FIELD_PATH = "/v1/environments/mock_envid/fields?version="
      + VERSION + "&collection_ids=mock_collid";
  private static final String EXPANSIONS_PATH = "/v1/environments/mock_envid/collections/mock_collid/expansions?version="
      + VERSION;
  ...
  public void createTrainingExampleIsSuccessful() throws InterruptedException {
    ...
    CreateTrainingExampleOptions.Builder builder = new CreateTrainingExampleOptions.Builder(environmentId, collectionId,
        queryId);
