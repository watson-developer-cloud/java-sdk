  ...
  public void testListConfigurationsOptions() throws Throwable {
    ListConfigurationsOptions listConfigurationsOptionsModel =
        new ListConfigurationsOptions.Builder()
            ...
            .name("testString")
            .build();
    assertEquals(listConfigurationsOptionsModel.environmentId(), "testString");
    assertEquals(listConfigurationsOptionsModel.name(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testListConfigurationsOptionsError() throws Throwable {
    new ListConfigurationsOptions.Builder().build();
  }
}
