...
public class EnvironmentTest {
  ...
  public void testEnvironment() throws Throwable {
    ...
    assertNull(environmentModel.getSize());
    assertNull(environmentModel.getRequestedSize());
    assertNull(environmentModel.getIndexCapacity());
    assertNull(environmentModel.getSearchStatus());
  }
}
