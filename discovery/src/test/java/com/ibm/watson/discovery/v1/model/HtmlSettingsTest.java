...
/** Unit test class for the HtmlSettings model. */
public class HtmlSettingsTest {
  ...
  public void testHtmlSettings() throws Throwable {
    ...
    HtmlSettings htmlSettingsModelNew = TestUtilities.deserialize(json, HtmlSettings.class);
    assertTrue(htmlSettingsModelNew instanceof HtmlSettings);
    assertEquals(htmlSettingsModelNew.keepContent().toString(), xPathPatternsModel.toString());
    assertEquals(htmlSettingsModelNew.excludeContent().toString(), xPathPatternsModel.toString());
  }
}
