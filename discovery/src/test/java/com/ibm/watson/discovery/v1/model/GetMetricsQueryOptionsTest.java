...
/** Unit test class for the GetMetricsQueryOptions model. */
public class GetMetricsQueryOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMetricsQueryOptions() throws Throwable {
    GetMetricsQueryOptions getMetricsQueryOptionsModel =
        new GetMetricsQueryOptions.Builder()
            ...
            .build();
    assertEquals(
        getMetricsQueryOptionsModel.startTime(),
        TestUtilities.createMockDateTime("2019-01-01T12:00:00"));
    assertEquals(
        getMetricsQueryOptionsModel.endTime(),
        TestUtilities.createMockDateTime("2019-01-01T12:00:00"));
    assertEquals(getMetricsQueryOptionsModel.resultType(), "document");
  }
}
