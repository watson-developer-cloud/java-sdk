...
/** Unit test class for the TrainingQuery model. */
public class TrainingQueryTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testTrainingQuery() throws Throwable {
    ...
    TrainingQuery trainingQueryModel =
    ...
    TrainingQuery trainingQueryModelNew = TestUtilities.deserialize(json, TrainingQuery.class);
    assertTrue(trainingQueryModelNew instanceof TrainingQuery);
    assertEquals(trainingQueryModelNew.naturalLanguageQuery(), "testString");
    assertEquals(trainingQueryModelNew.filter(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testTrainingQueryError() throws Throwable {
    new TrainingQuery.Builder().build();
  }
}
