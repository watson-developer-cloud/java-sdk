...
/** Unit test class for the GetMetricsEventRateOptions model. */
public class GetMetricsEventRateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMetricsEventRateOptions() throws Throwable {
    GetMetricsEventRateOptions getMetricsEventRateOptionsModel =
        new GetMetricsEventRateOptions.Builder()
            ...
            .build();
    assertEquals(
        getMetricsEventRateOptionsModel.startTime(),
        DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(
        getMetricsEventRateOptionsModel.endTime(),
        DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(getMetricsEventRateOptionsModel.resultType(), "document");
  }
}
