  ...
  public void testCreateEnvironmentOptions() throws Throwable {
    CreateEnvironmentOptions createEnvironmentOptionsModel =
        new CreateEnvironmentOptions.Builder()
            ...
            .size("LT")
            .build();
    assertEquals(createEnvironmentOptionsModel.name(), "testString");
    assertEquals(createEnvironmentOptionsModel.description(), "testString");
    assertEquals(createEnvironmentOptionsModel.size(), "LT");
  }
