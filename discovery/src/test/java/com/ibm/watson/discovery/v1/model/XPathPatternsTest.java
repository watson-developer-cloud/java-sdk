...
/** Unit test class for the XPathPatterns model. */
public class XPathPatternsTest {
  ...
  public void testXPathPatterns() throws Throwable {
    ...
    XPathPatterns xPathPatternsModelNew = TestUtilities.deserialize(json, XPathPatterns.class);
    assertTrue(xPathPatternsModelNew instanceof XPathPatterns);
  }
}
