...
/** Unit test class for the NluEnrichmentFeatures model. */
public class NluEnrichmentFeaturesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testNluEnrichmentFeatures() throws Throwable {
    ...
    String json = TestUtilities.serialize(nluEnrichmentFeaturesModel);

    NluEnrichmentFeatures nluEnrichmentFeaturesModelNew =
        TestUtilities.deserialize(json, NluEnrichmentFeatures.class);
    assertTrue(nluEnrichmentFeaturesModelNew instanceof NluEnrichmentFeatures);
    assertEquals(
        nluEnrichmentFeaturesModelNew.keywords().toString(), nluEnrichmentKeywordsModel.toString());
    assertEquals(
        nluEnrichmentFeaturesModelNew.entities().toString(), nluEnrichmentEntitiesModel.toString());
    assertEquals(
        nluEnrichmentFeaturesModelNew.sentiment().toString(),
        nluEnrichmentSentimentModel.toString());
    assertEquals(
        nluEnrichmentFeaturesModelNew.emotion().toString(), nluEnrichmentEmotionModel.toString());
    assertEquals(
        nluEnrichmentFeaturesModelNew.categories().toString(),
        java.util.Collections.singletonMap("anyKey", "anyValue").toString());
    assertEquals(
        nluEnrichmentFeaturesModelNew.semanticRoles().toString(),
        nluEnrichmentSemanticRolesModel.toString());
    assertEquals(
        nluEnrichmentFeaturesModelNew.relations().toString(),
        nluEnrichmentRelationsModel.toString());
    assertEquals(
        nluEnrichmentFeaturesModelNew.concepts().toString(), nluEnrichmentConceptsModel.toString());
  }
}
