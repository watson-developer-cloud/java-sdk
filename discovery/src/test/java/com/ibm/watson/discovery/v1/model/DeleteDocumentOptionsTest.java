...
/** Unit test class for the DeleteDocumentOptions model. */
public class DeleteDocumentOptionsTest {
  ...
  public void testDeleteDocumentOptions() throws Throwable {
    DeleteDocumentOptions deleteDocumentOptionsModel =
        new DeleteDocumentOptions.Builder()
            ...
            .build();
    assertEquals(deleteDocumentOptionsModel.environmentId(), "testString");
  ...
  public void testDeleteDocumentOptionsError() throws Throwable {
    new DeleteDocumentOptions.Builder().build();
  }
}
