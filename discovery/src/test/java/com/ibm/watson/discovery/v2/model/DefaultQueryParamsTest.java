...
/** Unit test class for the DefaultQueryParams model. */
public class DefaultQueryParamsTest {
  ...
  @Test
  public void testDefaultQueryParams() throws Throwable {
    ...
    DefaultQueryParams defaultQueryParamsModelNew =
        TestUtilities.deserialize(json, DefaultQueryParams.class);
    assertTrue(defaultQueryParamsModelNew instanceof DefaultQueryParams);
    assertEquals(
        defaultQueryParamsModelNew.passages().toString(),
        defaultQueryParamsPassagesModel.toString());
    assertEquals(
        defaultQueryParamsModelNew.tableResults().toString(),
        defaultQueryParamsTableResultsModel.toString());
    assertEquals(defaultQueryParamsModelNew.aggregation(), "testString");
    assertEquals(
        defaultQueryParamsModelNew.suggestedRefinements().toString(),
        defaultQueryParamsSuggestedRefinementsModel.toString());
    assertEquals(defaultQueryParamsModelNew.spellingSuggestions(), Boolean.valueOf(true));
    assertEquals(defaultQueryParamsModelNew.highlight(), Boolean.valueOf(true));
    assertEquals(defaultQueryParamsModelNew.count(), Long.valueOf("26"));
    assertEquals(defaultQueryParamsModelNew.sort(), "testString");
  }
}
