...
/** Unit test class for the UpdateCredentialsOptions model. */
public class UpdateCredentialsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCredentialsOptions() throws Throwable {
  ...
  public void testUpdateCredentialsOptionsError() throws Throwable {
    new UpdateCredentialsOptions.Builder().build();
  }
}
