...
/** Unit test class for the PdfHeadingDetection model. */
public class PdfHeadingDetectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPdfHeadingDetection() throws Throwable {
    ...
    String json = TestUtilities.serialize(pdfHeadingDetectionModel);

    PdfHeadingDetection pdfHeadingDetectionModelNew =
        TestUtilities.deserialize(json, PdfHeadingDetection.class);
    assertTrue(pdfHeadingDetectionModelNew instanceof PdfHeadingDetection);
  }
}
