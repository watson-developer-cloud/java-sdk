...
public class DiscoveryTest {
  ...
  public void testDeleteConfigurationWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody =
        "{\"configuration_id\": \"configurationId\", \"status\": \"deleted\", \"notices\": [{\"notice_id\": \"noticeId\", \"created\": \"2019-01-01T12:00:00\", \"document_id\": \"documentId\", \"query_id\": \"queryId\", \"severity\": \"warning\", \"step\": \"step\", \"description\": \"description\"}]}";
  ...
  public void testAddDocumentWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody =
        "{\"document_id\": \"documentId\", \"status\": \"processing\", \"notices\": [{\"notice_id\": \"noticeId\", \"created\": \"2019-01-01T12:00:00\", \"document_id\": \"documentId\", \"query_id\": \"queryId\", \"severity\": \"warning\", \"step\": \"step\", \"description\": \"description\"}]}";
  ...
  public void testGetDocumentStatusWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody =
        "{\"document_id\": \"documentId\", \"configuration_id\": \"configurationId\", \"status\": \"available\", \"status_description\": \"statusDescription\", \"filename\": \"filename\", \"file_type\": \"pdf\", \"sha1\": \"sha1\", \"notices\": [{\"notice_id\": \"noticeId\", \"created\": \"2019-01-01T12:00:00\", \"document_id\": \"documentId\", \"query_id\": \"queryId\", \"severity\": \"warning\", \"step\": \"step\", \"description\": \"description\"}]}";
  ...
  public void testQueryNoticesWOptions() throws Throwable {
    ...
    assertEquals(
        ...
        RequestUtils.join(
            new java.util.ArrayList<String>(java.util.Arrays.asList("testString")), ","));
    assertEquals(Boolean.valueOf(query.get("highlight")), Boolean.valueOf(true));
    assertEquals(
    ...
    assertEquals(Boolean.valueOf(query.get("similar")), Boolean.valueOf(true));
    assertEquals(
  ...
  public void testCreateEventWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody =
        "{\"type\": \"click\", \"data\": {\"environment_id\": \"environmentId\", \"session_token\": \"sessionToken\", \"client_timestamp\": \"2019-01-01T12:00:00\", \"display_rank\": 11, \"collection_id\": \"collectionId\", \"document_id\": \"documentId\", \"query_id\": \"queryId\"}}";
  ...
  public void testQueryLogWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody =
        "{\"matching_results\": 15, \"results\": [{\"environment_id\": \"environmentId\", \"customer_id\": \"customerId\", \"document_type\": \"query\", \"natural_language_query\": \"naturalLanguageQuery\", \"document_results\": {\"results\": [{\"position\": 8, \"document_id\": \"documentId\", \"score\": 5, \"confidence\": 10, \"collection_id\": \"collectionId\"}], \"count\": 5}, \"created_timestamp\": \"2019-01-01T12:00:00\", \"client_timestamp\": \"2019-01-01T12:00:00\", \"query_id\": \"queryId\", \"session_token\": \"sessionToken\", \"collection_id\": \"collectionId\", \"display_rank\": 11, \"document_id\": \"documentId\", \"event_type\": \"click\", \"result_type\": \"document\"}]}";
  ...
  public void testGetMetricsQueryWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody =
        "{\"aggregations\": [{\"interval\": \"interval\", \"event_type\": \"eventType\", \"results\": [{\"key_as_string\": \"2019-01-01T12:00:00\", \"key\": 3, \"matching_results\": 15, \"event_rate\": 9}]}]}";
