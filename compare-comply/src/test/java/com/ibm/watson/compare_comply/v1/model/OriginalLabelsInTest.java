...
/** Unit test class for the OriginalLabelsIn model. */
public class OriginalLabelsInTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testOriginalLabelsIn() throws Throwable {
    ...
    String json = TestUtilities.serialize(originalLabelsInModel);

    OriginalLabelsIn originalLabelsInModelNew =
        TestUtilities.deserialize(json, OriginalLabelsIn.class);
    assertTrue(originalLabelsInModelNew instanceof OriginalLabelsIn);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testOriginalLabelsInError() throws Throwable {
    new OriginalLabelsIn.Builder().build();
  }
}
