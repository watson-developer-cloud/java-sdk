...
/** Unit test class for the FeedbackDataInput model. */
public class FeedbackDataInputTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata =
      TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testFeedbackDataInput() throws Throwable {
    ...
    String json = TestUtilities.serialize(feedbackDataInputModel);

    FeedbackDataInput feedbackDataInputModelNew =
        TestUtilities.deserialize(json, FeedbackDataInput.class);
    assertTrue(feedbackDataInputModelNew instanceof FeedbackDataInput);
    assertEquals(feedbackDataInputModelNew.feedbackType(), "testString");
    assertEquals(feedbackDataInputModelNew.document().toString(), shortDocModel.toString());
    assertEquals(feedbackDataInputModelNew.modelId(), "testString");
    assertEquals(feedbackDataInputModelNew.modelVersion(), "testString");
    assertEquals(feedbackDataInputModelNew.location().toString(), locationModel.toString());
    assertEquals(feedbackDataInputModelNew.text(), "testString");
    assertEquals(
        feedbackDataInputModelNew.originalLabels().toString(), originalLabelsInModel.toString());
    assertEquals(
        feedbackDataInputModelNew.updatedLabels().toString(), updatedLabelsInModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testFeedbackDataInputError() throws Throwable {
    new FeedbackDataInput.Builder().build();
  }
}
