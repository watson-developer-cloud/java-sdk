...
public class PaymentTerms extends GenericModel {
   ...
   *
   * <p>The confidence level in the identification of the payment term.
   *
   ...
   *
   * <p>The normalized form of the payment term, which is listed as a string. This element is
