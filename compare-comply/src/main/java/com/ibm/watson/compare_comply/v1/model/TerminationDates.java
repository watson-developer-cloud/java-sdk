...
public class TerminationDates extends GenericModel {
   ...
   *
   * <p>The confidence level in the identification of the termination date.
   *
   ...
   *
   * <p>The normalized form of the termination date, which is listed as a string. This element is
