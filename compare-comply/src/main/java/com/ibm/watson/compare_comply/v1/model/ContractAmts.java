...
public class ContractAmts extends GenericModel {
   ...
   *
   * <p>The confidence level in the identification of the contract amount.
   *
   ...
   *
   * <p>The normalized form of the amount, which is listed as a string. This element is optional; it
