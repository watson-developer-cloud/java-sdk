 ...
 * the License.
 */
package watson.developer_cloud.service;
...
import service_core.util.alchemy.AlchemyEndPoints;
import conversation.v1.ConversationService;
import dialog.v1.DialogService;
import document_conversion.v1.DocumentConversion;
...
import nlc.v1.NaturalLanguageClassifier;
import personality_insights.v2.PersonalityInsights;
...
import service_core.service.exception.*;
import speech_to_text.v1.SpeechToText;
import speech_to_text.v1.util.MediaTypeUtils;
import text_to_speech.v1.TextToSpeech;
import text_to_speech.v1.util.WaveUtils;
import tone_analyzer.v3.ToneAnalyzer;
import tradeoff_analytics.v1.TradeoffAnalytics;
import service_core.util.*;
