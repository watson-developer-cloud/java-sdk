package watson.developer_cloud.util;
...
import speech_to_text.v1.model.SpeechWordConfidence;
import speech_to_text.v1.util.SpeechTimestampTypeAdapter;
import speech_to_text.v1.util.SpeechWordConfidenceTypeAdapter;
...
public class TypeAdaptersTest {
  ...
  public void testSpeechTimestampTypeAdapter() {
    final Gson gson = new GsonBuilder().registerTypeAdapter(SpeechTimestamp.class, new SpeechTimestampTypeAdapter()).create();
